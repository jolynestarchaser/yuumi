...
export type CompanionActionValues = Partial<CompanionSetup> & { text?: string; color?: string; expectedRevision?: number; memoryId?: string; predecessorId?: string; language?: 'th' | 'en' };

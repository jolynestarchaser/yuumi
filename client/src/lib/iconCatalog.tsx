...
const iconRows: [string, string, string, import('lucide-react').LucideIcon][] = [
...
export const iconCatalog = iconRows.map(([key, label, category, Icon]) => ({ key, label, category, Icon }));
